...
Transform::Transform(std::string File, std::string ArgName, unsigned int ArgId, Object *obj, std::vector<glm::vec3> aPoints, bool LuaComp)
: Component(std::move(File), std::move(ArgName), ArgId, obj,LuaComp), Position("Position", Variables), Rotation("Rotation", Variables), Size("Size", Variables), OriginalPoints(aPoints)
{
